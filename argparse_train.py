...
def parse_args(input_args=None):
    ...
    # model
    parser.add_argument("--model-name", type=str, default="meanflow", choices=["esc", "meanflow", "scm", "scd"])
    ...
    parser.add_argument("--loss-type", default="adaptive", type=str, choices=["l2", "adaptive"], help="Loss weighting type")
    ...
    parser.add_argument("--grad-warmup-steps", type=int, default=10000, help="Term zero steps")
    ...
    parser.add_argument("--use-vplug", action=argparse.BooleanOptionalAction, default=True)

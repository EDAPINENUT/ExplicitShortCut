...
def parse_args(input_args=None):
    ...
    # model
    parser.add_argument("--model-name", type=str, default="imm", choices=["esc", "meanflow", "scm", "scd", "imm"])
    ...
    parser.add_argument("--variational-adaptive-weight", action=argparse.BooleanOptionalAction, default=True)
